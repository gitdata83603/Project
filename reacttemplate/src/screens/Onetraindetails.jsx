...
function Onetraindetails() {
 ...
 return(
  <div>
    <Navbar/>
    <h2 className='page-header'>Train Details</h2>
       <div className="container mt-3">
           ...
           <h5 style={{marginTop:'80px',fontSize: '20px',
                        fontWeight: 'bold'}}>Routes[distance](arrivalTime)</h5>
           <div className="container mt-3">
          <div style={{
...
export default Onetraindetails